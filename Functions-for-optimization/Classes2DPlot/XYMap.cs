...
namespace _3D_Chart_WPF_v1
{
    internal class XYMap
    {
        ...
        public XYMap(double width, double height, int contours = 5, double Xmin = -10, double Xmax = 10, double Ymin = -10, double Ymax = 10, double spacing = 0.1)
        {
        ...
        public void Draw2DPlot(DrawingContext dc)
        {
            for (int i = 0; i < pts.GetLength(0); i++)
            {
                for (int j = 0; j < pts.GetLength(1); j++)
