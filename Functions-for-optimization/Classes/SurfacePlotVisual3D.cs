...
namespace WPFSurfacePlot3D
{
    public class SurfacePlotVisual3D : ModelVisual3D
    {
        ...
        //public Point3D OnePoint = new Point3D();

        public Point3D OnePoint
        {
            get { return (Point3D)GetValue(OnePointProperty); }
            set { SetValue(OnePointProperty, value); }
        }
        public static readonly DependencyProperty OnePointProperty = DependencyProperty.Register("OnePoint", typeof(Point3D), typeof(SurfacePlotVisual3D), new UIPropertyMetadata(SamplePoint, ModelWasChanged));
        ...
        {
            if (DataPoints is null) return null;
        ...
        public static Point3D SamplePoint
        {
